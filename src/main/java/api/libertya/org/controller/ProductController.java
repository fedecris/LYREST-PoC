...
public class ProductController extends GeneralController {
    ...
    @GetMapping(path = Paths.PRODUCT + "/{productID}")
    ...
    @DeleteMapping(path = Paths.PRODUCT + "/{productID}")
    ...
    @PutMapping(path = Paths.PRODUCT + "/{productID}")
    ...
    @PostMapping(path = Paths.PRODUCT)
